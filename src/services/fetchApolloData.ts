...
const COUNTRY_MOCKS: Record<string, CountryMockData> = {
  US: {
    ...
    companies: [
      "Stripe", "Snowflake", "Datadog", "Cloudflare", "HashiCorp",
      "Figma", "Notion", "Plaid", "Vercel", "OpenAI",
      "Airtable", "Databricks", "Palo Alto Networks", "Twilio", "HubSpot",
      "Rippling", "Amplitude", "Scale AI", "Drata", "Anduril",
    ],
